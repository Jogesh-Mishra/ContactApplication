                ...
                if(etMail.getText().toString().isEmpty()||etPassword.getText().toString().isEmpty())
                    ...
                    Backendless.UserService.login(email, pass, new AsyncCallback<BackendlessUser>() {
                        ...
                        public void handleResponse(BackendlessUser response) {
                            ...
                            Test_Application.user=response;
        ...
        tvReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(etMail.getText().toString().isEmpty())
                    Toast.makeText(Login.this, "Please Enter your Email Above for Reset Password", Toast.LENGTH_LONG).show();
                else {
                    ...
                    Backendless.UserService.restorePassword(mail, new AsyncCallback<Void>() {
                        ...
                        public void handleResponse(Void response) {
                            Toast.makeText(Login.this, "Password Reset Mail has been Sent to your E-Mail", Toast.LENGTH_LONG).show();
                            showProgress(false);
                        }
